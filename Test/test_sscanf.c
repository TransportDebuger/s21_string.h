...
//   int our = s21_sscanf("D thg 18446744073709551616", "%c thg %llu", &c2,
//   &u2); ck_assert_uint_eq(c1, c2); ck_assert_uint_eq(u1, u2);
//   ck_assert_int_eq(their, our);
// }
// END_TEST
...
//   int our = s21_sscanf("D thg -18446744073709551616", "%c ppc %llu", &c2,
//   &u2); ck_assert_uint_eq(c1, c2); ck_assert_uint_eq(u1, u2);
//   ck_assert_int_eq(their, our);
// }
// END_TEST
...
//   int their =
//       sscanf(" D thg -7777777777777777777753479797", "%c ppc %llo", &c1,
//       &u1);
...
//   char s1[100] = {'\0'}, s2[100] = {'\0'}, s3[100] = {'\0'}, s4[100] =
//   {'\0'},
//        s5[100] = {'\0'}, s6[100] = {'\0'};
...
//   char s1[100] = {0}, s2[100] = {0};
//   char c1 = 0, c2 = 0;
//   int their = sscanf("4 123 BiliL 12e34 13.37", "%i%d%4s%c%e%g", &i1, &d1,
//   s1,
//                      &c1, &e1, &f1);
...
//   char s1[100] = {0}, s2[100] = {0};
//   char c1 = 0, c2 = 0;
//   int their = sscanf("4 123 BiliL 12e34 13.37 .2345", "%i %d %4s %c %e %g
//   %f",
//                      &i1, &d1, s1, &c1, &e1, &f1, &f3);
//   int our = s21_sscanf("4 123 BiliL 12e34 13.37 .2345", "%i %d %4s %c %e %g
//   %f",
...
//   unsigned int o1 = 0, o2 = 0;
//   int their =
//       sscanf("4 123 BiliL 12e34 13.37 .2345 345", "%i %d %4s %c %e %g %f
//       %2o",
...
//                        "%i %d %4s %c %e %g %f %2o %x", &i2, &d2, s2, &c2,
//                        &e2, &f2, &f4, &o2, &x2);
//   ck_assert_int_eq(i1, i2);
//   ck_assert_int_eq(d1, d2);
//   ck_assert_str_eq(s1, s2);
...
//                      &e1, &f1, &f3, &o1, &x1, &n1);
//   int our = s21_sscanf("4 123 BiliL 12e34 13.37 .2345 345 0x345f%",
//                        "%i %d %4s %c %e %g %f %2o %x %% %n", &i2, &d2, s2,
//                        &c2, &e2, &f2, &f4, &o2, &x2, &n2);
//   ck_assert_int_eq(i1, i2);
//   ck_assert_int_eq(d1, d2);
//   ck_assert_str_eq(s1, s2);
//   ck_assert_int_eq(c1, c2);
...
//                        "%i %d %4s %c %e %g %f %2o %x %% %n %3u", &i2, &d2,
//                        s2, &c2, &e2, &f2, &f4, &o2, &x2, &n2, &u2);
//   ck_assert_int_eq(i1, i2);
//   ck_assert_int_eq(d1, d2);
//   ck_assert_str_eq(s1, s2);
//   ck_assert_int_eq(c1, c2);
...
//   int our =
//       s21_sscanf("4 123 BiliL 12e34 13.37 .2345 345 0x345f% 453478
//       0x57890ff",
//                  "%i %d %4s %c %e %g %f %2o %x %% %n %3u %p", &i2, &d2, s2,
//                  &c2, &e2, &f2, &f4, &o2, &x2, &n2, &u2, &p2);
//   ck_assert_int_eq(i1, i2);
//   ck_assert_int_eq(d1, d2);
//   ck_assert_str_eq(s1, s2);
//   ck_assert_int_eq(c1, c2);
...
// START_TEST(all) {
//   float e1 = 0, e2 = 0, f1 = 0, f2 = 0, f3 = 0, f4 = 0, E1 = 0, E2 = 0, G1 =
//   0,
//         G2 = 0;
...
//       &d1, s1, &c1, &e1, &E1, &f3, &f1, &G1, &o1, &u1, &x1, &X1, &p1, &n1,
//       s3);
//   int our = s21_sscanf(
//       "4 123 BobiJoe 12e34 43e21 13.37 2.28 1337.228 101 1854 12ab BA21 ILYA-
//       "
...
//       &d2, s2, &c2, &e2, &E2, &f4, &f2, &G2, &o2, &u2, &x2, &X2, &p2, &n2,
//       s4);
//   ck_assert_int_eq(i1, i2);
//   ck_assert_int_eq(d1, d2);
//   ck_assert_str_eq(s1, s2);
